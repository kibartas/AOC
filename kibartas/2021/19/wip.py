...
largest_distance = 0
all_key_combs = combinations(positions.keys(), 2)
for keys in all_key_combs:
    position_1 = positions[keys[0]]
    position_2 = positions[keys[1]]
    distance = abs(position_1[0] - position_2[0]) + abs(position_1[1] -
                                                        position_2[1]) + abs(position_1[2] - position_2[2])
    if distance > largest_distance:
        largest_distance = distance

print(positions)
print("Part 1 result: {}".format(result))
print("Part 2 result: {}".format(largest_distance))
